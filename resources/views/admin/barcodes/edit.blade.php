<x-app-layout>
  ...
  <div class="mx-auto w-full max-w-3xl px-4 pb-6 pt-6">
    <div class="flex items-center gap-3">
      ...
      <div>
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Barcode</h1>
        <p class="text-sm text-gray-500 dark:text-gray-400">Perbarui informasi titik absen</p>
      </div>
    </div>
      ...
      <form action="{{ route('admin.barcodes.update', $barcode->id) }}" method="post">
        ...
        <div class="flex flex-col gap-4 md:flex-row md:items-start md:gap-4">
          <div class="w-full">
            ...
            <x-input name="name" id="name" class="mt-2 block w-full rounded-xl" type="text"
        ...
        <div class="mt-5">
          ...
          <x-input name="radius" id="radius" class="mt-2 block w-full rounded-xl" type="number" :value="old('radius') ?? $barcode->radius"
        ...
        <div class="mt-6 border-t border-gray-100 pt-5 dark:border-gray-700">
          ...
          <div class="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
            <div class="w-full">
              ...
              <x-input name="lat" id="lat" class="mt-2 block w-full rounded-xl" type="text" :value="old('lat') ?? $barcode->latLng['lat']"
            ...
            <div class="w-full">
              ...
              <x-input name="lng" id="lng" class="mt-2 block w-full rounded-xl" type="text" :value="old('lng') ?? $barcode->latLng['lng']"
                placeholder="cth: 6.12345" />
              @error('lng')
