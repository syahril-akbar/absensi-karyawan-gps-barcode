<x-app-layout>
  <div class="mx-auto w-full max-w-7xl px-4 pb-6 pt-6 sm:px-6 lg:px-8">
    <div class="flex items-center gap-3">
      ...
      <div>
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Shift</h1>
        <p class="text-sm text-gray-500 dark:text-gray-400">Kelola master data jam kerja shift</p>
      </div>
    </div>
